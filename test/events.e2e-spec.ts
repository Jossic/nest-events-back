...
describe('Events (e2e)', () => {
  ...
  it.skip('should return an empty list of events', async () => {
  ...
  it.skip('should return a single event', async () => {
  ...
  it.skip('should return a list of (2) events', async () => {
  ...
  it.skip('should update an event name', async () => {
    await loadFixtures('1-event-1-user.sql');
  ...
  it.skip('should remove an event', async () => {
    await loadFixtures('1-event-1-user.sql');
